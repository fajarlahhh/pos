                ...
                <div class="col-xl-3 col-sm-6">
                    @role('super-admin|user')
                        <div class="form-inline">
                            <a href="{{ route('pengguna.tambah') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Tambah</a>
                        </div>
                    @endrole
                </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 1 || data == 0)
                        Toast.fire({
                            icon: 'success',
                            title: 'Berhasil ' + (data == 1 ? 'mengaktifkan' : 'menonaktifkan') +
                                ' pengguna'
                        });
                    else
                        Swal.fire({
                            icon: 'error',
                            title: (data == 1 ? 'Mengaktifkan' : 'Menonaktifkan') + ' Data',
                            text: data
                        });
                },
