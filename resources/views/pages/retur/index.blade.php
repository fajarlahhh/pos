            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <span data-toggle="tooltip" data-container="body" data-placement="right" data-html="true" data-placement="top" title="{!! $row->pengguna->nama.", <br><small>".$row->updated_at."</small>" !!}">{{ $row->updated_at }}</span>
                    </td>
                    <td class="text-nowrap align-middle">{{ $row->faktur }}</td>
                    <td class="text-nowrap align-middle">{{ $row->supplier? $row->supplier->nama: '' }}</td>
                    <td class="text-nowrap align-middle">{{ $row->jatuh_tempo? date('d F Y', strtotime($row->jatuh_tempo)): '' }}</td>
                    ...
                    <td>
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap text-right">{{ number_format($det->harga_barang, 2) }}</td>
