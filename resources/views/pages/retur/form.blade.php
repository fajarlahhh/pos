    ...
    <form action="{{ route('barangmasuk.simpan') }}" method="post" data-parsley-validate="true" >
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <input type="text" readonly class="form-control datepicker" id="tanggal" name="tanggal" value="{{ date('d M Y', strtotime(old('tanggal', now()))) }}" required/>
            </div>
            <div class="form-group">
                <label class="control-label">No. Faktur</label>
                <input class="form-control" type="text" name="faktur" value="{{ old('faktur') }}" autocomplete="off" required/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="sales" value="{{ old('sales') }}" autocomplete="off"/>
            </div>
            <div class="form-group">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="3" class="with-btn">
                                    <input type="text" class="form-control text-right currency" id="sub-total-harga" name="sub_total" value="{{ old('sub_total', 0) }}" autocomplete="off" readonly/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3" class="with-btn">
                                    <input type="text" class="form-control text-right currency" id="sub-total-ppn" name="sub_total_ppn" value="{{ old('sub_total_ppn', 0) }}" autocomplete="off" readonly/>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
