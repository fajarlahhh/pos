                            ...
                            <div class="form-group">
                                <select class="form-control selectpicker cari" name="jenis" data-live-search="true"
                                    ...
                                    @foreach ($jenis_barang as $row)
                                        <option value="{{ $row->id }}" {{ $jenis == $row->id ? 'selected' : '' }}>
                                            {{ $row->nama }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <tbody>
                        @foreach ($data as $index => $row)
                            <tr>
                                ...
                                <td class="align-middle text-right text-nowrap">{{ number_format($row->harga, 2) }}</td>
                                        ...
                                        <div class="btn-group">
                                            @if ($row->trashed())
                                                <a href="javascript:;" data-id="{{ $row->id }}" data-no="{{ $i }}"
                                                    class="btn btn-danger btn-sm btn-restore">
                                                    Restore</a>
                                            @else
