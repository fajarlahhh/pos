                ...
                <div class="col-xl-3 col-sm-3">
                    @role('user|super-admin|supervisor')
                        <div class="form-inline">
                            <a href="{{ route('supplier.tambah') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Tambah</a>
                        </div>
                    @endrole
                </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <span data-toggle="tooltip" data-container="body" data-placement="right" data-html="true"
                                        data-placement="top" title="{!! $row->pengguna->nama . ', <br><small>' . $row->updated_at . '</small>' !!}">{{ $row->nama }}</span>
                                </td>
                                        ...
                                        <div class="btn-group">
                                            @if ($row->trashed())
                                                <a href="javascript:;" data-id="{{ $row->id }}"
                                                    data-no="{{ $i }}" class="btn btn-danger btn-sm btn-restore">
                                                    Restore</a>
                                            @else
