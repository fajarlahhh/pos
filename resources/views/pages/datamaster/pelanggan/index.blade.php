        ...
        <div class="row width-full">
            <div class="col-xl-3 col-sm-3">
                ...
                <div class="form-inline">
                    <a href="{{ route('pelanggan.tambah') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                </div>
                @endrole
            </div>
            <div class="col-xl-9 col-sm-9">
                <form id="frm-cari" action="{{ route('pelanggan') }}" method="GET">
