        ...
        <div class="row width-full">
            <div class="col-xl-3 col-sm-3">
                ...
                <div class="form-inline">
                    <a href="{{ route('penjualan.tambah') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                </div>
                @endrole
            </div>
                ...
                <tr>
                    ...
                    <td class="with-btn-group align-middle" nowrap>
                        <div class="btn-group">
                            ...
                            @endrole
                            @else
                            <a href="/penjualan/kwitansi/1/{{ $row->penjualan_id }}" target="_blank" class="btn-sm btn btn-aqua" >Cetak</a>
                            @role('super-admin')
