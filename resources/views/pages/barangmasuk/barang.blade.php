<tr>
    ...
    <td class="with-btn width-100">
        <input class="form-control ppn hitungan" type="number" name="barang_masuk[{{ $id }}][barang_masuk_harga_ppn]" value="{{ $data? $data['barang_masuk_harga_ppn']: 0 }}" autocomplete="off" required/>
    </td>
    <td class="with-btn width-100">
