        ...
        <form action="{{ route('barangmasuk.simpan') }}" method="post" data-parsley-validate="true">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="faktur" value="{{ old('faktur') }}" autocomplete="off"
                        required />
                </div>
                <div class="form-group">
                    <label class="control-label">Supplier</label>
                    <select class="form-control selectpicker" name="supplier_id" id="supplier_id" data-live-search="true"
                        data-style="btn-warning" data-width="100%" required>
                        <option value="" {{ old('supplier_id') == '' ? 'selected' : '' }}>-- Pilih Supplier --
                        </option>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" readonly class="form-control datepicker" id="tanggal_jatuh_tempo"
                            name="jatuh_tempo" value="{{ date('d M Y', strtotime(old('jatuh_tempo', now()))) }}" required
                            disabled />
                    </div>
                </div>
                <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td class="with-btn">
                                        <input type="text" class="form-control text-right currency" id="sub-total-harga"
                                            name="sub_total" value="{{ old('sub_total') }}" autocomplete="off"
                                            readonly required/>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
    ...
    <script>
        ...
        function init_hitungan() {
            $(".hitungan").on("keyup change", function() {
                ...
                $(this).closest("tr").find(".total-harga").val((harga * qty).toFixed(2)
