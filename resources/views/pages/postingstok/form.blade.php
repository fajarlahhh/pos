        ...
        <form id="form-posting" method="post">
            ...
            <div class="panel-body">
                <div class="form-group input-group-sm">
                    ...
                    <select class="form-control selectpicker" id="bulan" data-live-search="true" data-style="btn-info"
                        data-width="100%">
                        @for ($i = 1; $i < 13; $i++)
                ...
                <div class="form-group input-group-sm">
                    ...
                    <select class="form-control selectpicker" id="tahun" data-live-search="true" data-style="btn-info"
                        data-width="100%">
