                ...
                <div class="widget-todolist-header bg-warning">
                    ...
                    <div class="widget-todolist-header-right">
                        <div class="widget-todolist-header-total">
                            <span>{{ $barang_masuk->count() }}</span><small>Faktur</small></div>
                    </div>
                </div>
                    ...
                    @foreach ($barang_masuk as $row)
                        <div class="widget-todolist-item">
                            <div class="widget-todolist-content">
                                <h4 class="widget-todolist-title">
                                    {{ \Carbon\Carbon::parse($row->tanggal)->isoFormat('LL') }}</h4>
                                <p class="widget-todolist-desc">
                                    {{ $row->faktur . ' - ' . ($row->supplier ? $row->supplier->nama : '') }}</p>
                            </div>
                            <div class="widget-todolist-icon">
                                <a href="#" class="btn-barang-masuk" data-id="{{ $row->id }}"
                                    data-faktur="{{ $row->faktur . ' - ' . ($row->supplier ? $row->supplier->nama : '') }}"><span
                                        class="badge badge-warning">Detail</span> </a>
                            </div>
                        </div>
                    @endforeach
                </div>
        ...
        <div class="col-lg-6 col-xl-4 col-md-6 m-t-15">
            <div class="widget-todolist widget-todolist-rounded " data-id="widget">
                ...
                <div class="widget-todolist-header bg-success">
                    ...
                    <div class="widget-todolist-header-right">
                        <div class="widget-todolist-header-total">
                            <span>{{ $penjualan->count() }}</span><small>Penjualan</small></div>
                    </div>
                </div>
                <div class="widget-todolist-body overflow-auto height-300">
                        ...
                        <div class="widget-todolist-item">
                            <div class="widget-todolist-content">
                                <h4 class="widget-todolist-title">
                                    {{ \Carbon\Carbon::parse($row->tanggal)->isoFormat('LL') }}</h4>
                                <p class="widget-todolist-desc">
                                    {{ $row->id . ' - ' . ($row->pelanggan ? $row->pelanggan->nama : '') }}</p>
                            </div>
                            <div class="widget-todolist-icon">
                                <a href="#" class="btn-penjualan" data-id="{{ $row->id }}"
                                    data-faktur="{{ $row->id . ' - ' . ($row->pelanggan ? $row->pelanggan->nama : '') }}"><span
                                        class="badge badge-warning">Detail</span> </a>
                            </div>
                        </div>
                    @endforeach
